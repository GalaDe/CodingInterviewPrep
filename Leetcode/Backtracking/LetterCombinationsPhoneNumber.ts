...
//Recursive Approach
export function letterCombinations_recursive1(digits: string): string[] {
...
//Dynamic Approach
export function letterCombinations_dynamic(digits: string): string[] {
    if (digits.length === 0) {
      return [];
    }
  ...
  export function letterCombinations_recursive2(digits: string): string[] {
    ...
    if (digits == null || digits.length === 0) return results;
      ...
      function backTrack(index, currentChar): void {
