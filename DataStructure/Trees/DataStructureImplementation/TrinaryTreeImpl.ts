...
export class TrinaryNode{

    left: TrinaryNode | null;
    middle: TrinaryNode | null;
    right: TrinaryNode | null;
    val: any;
...
export class TrinaryTree{
    root: TrinaryNode | null;

    insert(val: any){
        this.root = this.insertNode(this.root, val);
        return this.root;
    }
    insertNode(tree: TrinaryNode, val: any){
        if(tree == null){
    ...
    deleteNode(current: TrinaryNode, parentNode: TrinaryNode, valToDel: any) {
    ...
    //Root-Left-Right
    preorderPrint(tree: TrinaryNode){
        if(tree == null) return;
    ...
    //Left-Right-Root
    postorderPrint(tree: TrinaryNode){
        if(tree == null) return;
