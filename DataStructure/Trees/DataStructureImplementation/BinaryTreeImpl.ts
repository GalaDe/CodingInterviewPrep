...
export class BinaryTree{
    ...
    insert(btree: BTNode, val: any){
        ...
        while(queue.length > 0){
            ...
            else queue.push(btree.left);

            if(btree.right == null){
                btree.right = new BTNode(val);
                break;
            }
            else queue.push(btree.right);
        }
    }
    ...
    insert2(val: any){
        ...
        while(queue.length > 0){
            ...
            else queue.push(tmp.left);

            if(tmp.right == null){
                tmp.right = new BTNode(val);
                break;
            }
            else queue.push(tmp.right);
        }
        return this.btree
    }

    delete(root: BTNode, key){
        if (root == null)
            return;
        ...
        let temp: BTNode = null;
        let keyNode: BTNode = null;
        let last: BTNode = null;
    ...
    calculateHeightOfTree(root: BTNode){
    ...
    calculateSizeOfTree(root: BTNode){
