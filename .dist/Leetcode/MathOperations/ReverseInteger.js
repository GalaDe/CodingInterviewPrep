...
function reverse_2(x) {
    //x = 312  
    let s = x.toString().split("").reverse().join(''); // s = '312'
    let reverseNum = parseInt(s, 10); //Converts string to an integer. Use 10 to specify base -> reverseNum = 213
