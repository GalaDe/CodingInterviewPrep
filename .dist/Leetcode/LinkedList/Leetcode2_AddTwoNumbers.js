...
function addTwoNumbers(l1, l2) {
    var _a, _b;
    let dummyHead = new SinglyLinkedListImpl_1.ListNode(0);
    let currentHead1 = l1;
    let currentHead2 = l2;
    ...
    while (currentHead1 || currentHead2 || carry) {
        ...
        currentHead3.next = new SinglyLinkedListImpl_1.ListNode(sum % 10);
        // advance heads
...
;
//# sourceMappingURL=Leetcode2_AddTwoNumbers.js.map