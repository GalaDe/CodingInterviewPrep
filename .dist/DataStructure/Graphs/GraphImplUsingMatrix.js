...
exports.GraphImplUsingMatrix = void 0;
/*
...
class GraphImplUsingMatrix {
    ...
    addConnection(vertex1, vertex2, isDirected) {
    ...
    printDfsRecHelper(startingVertex, visited) {
        ...
        if (startingVertex == null || indx == -1)
            throw new Error('Provide valid vertex');
...
exports.GraphImplUsingMatrix = GraphImplUsingMatrix;
//# sourceMappingURL=GraphImplUsingMatrix.js.map