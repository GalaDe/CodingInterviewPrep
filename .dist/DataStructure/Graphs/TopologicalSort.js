...
exports.GraphImplTopologicalSort = void 0;
class GraphImplTopologicalSort {
    constructor() {
    ...
    */
    topologicalSortDfs() {
        let tSort = [];
        let inDegree = new Map(); // map will keep track of # of edges comming to vertex V.
...
exports.GraphImplTopologicalSort = GraphImplTopologicalSort;
