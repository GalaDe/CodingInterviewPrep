...
class Trie {
    ...
    */
    ...
    searchWord(word) {
        if (word.length == 0)
            throw new Error("There are no string has been provided");
        let current = this.root;
        for (const char of word) {
    ...
    printWord_rec_helper(currNode, arr, perfix) {
        if (currNode.isWord)
...
exports.Trie = Trie;
//# sourceMappingURL=TrieTreeImpl.js.map