...
exports.deletion2 = exports.deletion1 = exports.inorder = exports.BinaryTreeNode = void 0;
...
exports.deletion1 = deletion1;
//IMPROVED Function -- doesn't use deleteDeepest
function deletion2(root, key) {
    if (root == null)
        return;
    if (root.left == null && root.right == null) {
        if (root.key == key) {
...
exports.deletion2 = deletion2;
//# sourceMappingURL=BinaryTreeImpl2.js.map