...
exports.myAtoi_2 = exports.myAtoi = void 0;
...
function myAtoi(s) {
    ...
    if (sign == '-' && sign.length == 1)
        res = sign + res;
    if (sign == '-' || sign == '+' && sign.length > 1)
        return 0;
    if (parseInt(res) > Math.pow(2, 31))
        return 2147483648;
    if (parseInt(res) < Math.pow(-2, 31))
        return -2147483648;
    return parseInt(res);
...
function myAtoi_4(s) {
    ...
    for (let i = start; i < s.length; i++) {
        let code = s.charCodeAt(i) - '0'.charCodeAt(0);
        if (code < 0 || code > 9)
            return sign * result;
...
;
//# sourceMappingURL=ConvertStringToInt.js.map